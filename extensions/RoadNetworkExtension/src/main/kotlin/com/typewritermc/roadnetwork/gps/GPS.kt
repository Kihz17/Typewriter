...
// TODO: Make navigation activities use new pathfinding
// TODO: Fix problems with pathfinding in slabs
// TODO: Get rid of radius component
// TODO: Sometimes can't link nodes (distance limit?)
// TODO: Recalc edges (Should actually show the correct progress bar & load unloaded chunks)
// TODO: NPCs getting stuck?
...
fun roadNetworkFindPath(
    ...
    centerPathWeight: Float = 0.0F,
): IPath? {
    return roadNetworkFindPath(start, end, HydrazinePathFinder(entity, instance), nodes, negativeNodes, centerPathWeight)
}
...
fun roadNetworkFindPath(
    ...
    // Higher number = path stays closer to the direct line between the nodes
    pathfinder.setPerpendicularWeight(centerPathWeight)
